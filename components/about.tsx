          ...
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground font-mono">
                ...
                are women. Across Africa, women represent{" "}
                <strong>less than 8%</strong> of technical talent pipelines.
              </p>
            </div>
            <div>
              <h3 className="mb-2 text-xl font-medium font-mono text-white">
              ...
              <p className="text-muted-foreground font-mono">
                Women make up <strong>the majority of the unbanked</strong>{" "}
            ...
            <div>
              ...
              <p className="text-muted-foreground font-mono">
                ...
                but <strong>women are almost never in the room</strong> when
                these tools are being designed.
              </p>
            </div>
            <div>
              <h3 className="mb-2 text-xl font-medium font-mono text-white">
              ...
              <p className="text-muted-foreground font-mono">
                ...
                to <strong>shape the future of freedom tech</strong>, not just
                consume it.
              </p>
            </div>
          </div>
